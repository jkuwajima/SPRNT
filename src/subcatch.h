...
class Subcatchment {
 ...
 public:
  ...
  node_id MakeNode(int id, float s0, float n, double x, double y, float q0, float a0, float z0, float h0, 
		   XsecType tp, double b0, int print);  // RECT
  node_id MakeNode(int id, float s0, float n, double x, double y, float q0, float a0, float z0, float h0, 
		   XsecType tp, double b0, double s, int print);  // TRAP
  node_id MakeNode(int id, float s0, float n, double x, double y, float q0, float a0, float z0, float h0, 
		   XsecType tp, int sec_num, double *xsecx, double *xsecy, int print); // XY
  node_id MakeNode(int id, float s0, float n, double x, double y, float q0, float a0, float z0, float h0, 
		   XsecType tp, int num_pt, double *aa, double *pp, double *yy, double *ww, int print); // INTRINSIC
